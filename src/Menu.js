...
const Menu = () => {
  ...
  return (
    <div className="container menu-parent-div">
    <div className="animate-text menu-header"> 
      <p className="font-weight-bold header-bold"><h1>Welcome to Tasty Dishes</h1>Welcome to CJ's delicious universe. Discover the Delectable Delights on Our Exquisite Restaurant Menu! <br></br>Everything from our Big on Breakfast, Perfected Drinks, Decadent to your Generous Big Meals Right here at your fingertips.<br></br>ORDER NOW!</p>
    </div>
    <div>
          {/* Menu Row 1 */}
