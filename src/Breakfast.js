...
function Breakfast() {
  ...
  return (
    <div className="container">
      ...
      <p style={{textAlign: "center"}}>Welcome to Tasty Dishes – Where Breakfast Dreams Come True!</p>
      <p style={{textAlign: "center"}}>
        At Tasty Dishes, we believe that breakfast is not just the most
        important meal of the day; it's a delightful experience that sets the
        tone for your entire day. Our breakfast menu is carefully crafted to
        bring you a burst of flavors, freshness, and comfort, all in one
        delightful spread.
      </p>
      <p style={{textAlign: "center"}}>
        From the Tasty Dishes team, we look forward to serving you the breakfast
